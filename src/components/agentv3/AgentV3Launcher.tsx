...
/**
 * AgentV3Launcher — the floating entry point to the v5.0 builder.
 *
 ...
 * live app is unchanged. Enabled → a small floating button OPENS v5.0 as a real
...
export function AgentV3Launcher({ userId, email, onOpen }: { userId?: string; email?: string; onOpen: () => void }) {
  ...
  return (
    <button
      onClick={onOpen}
      title="Open NavBharatAI Pro v5.0"
