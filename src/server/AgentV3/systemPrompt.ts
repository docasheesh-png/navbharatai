...
export function architectSystemPrompt(framework?: string, opts?: { parallelBuild?: boolean }): string {
  ...
  return [
    ...
    '  Use images the user gave you; otherwise draw the picture yourself — a CSS gradient panel, an emoji',
    '  or icon inside a coloured tile, or a small inline SVG. A designed placeholder always renders; a',
    '  guessed photo often does not.',
