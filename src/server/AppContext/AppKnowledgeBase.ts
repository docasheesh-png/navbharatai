...
export const APP_KNOWLEDGE_BASE: AppFeature[] = [
  ...
  },
  {
    ...
    description:
      'A 100% on-device assistant that works even with NO internet. It knows every feature of NavBharatAI — where each button/option is, what it does, and how to use it — and answers instantly from the built-in app knowledge, so it never guesses. Ask "where is X" or "how do I Y" and it shows the exact place with step-by-step how-to, plus a direct "Open →" button that takes you straight to that page. It shows a live badge telling you whether you are online or using the offline on-device guide. Note: building apps and full Pro chat need the internet — the Offline AI points you online for those. It updates itself automatically: any new NavBharatAI feature becomes answerable here the moment it ships.',
    howToUse:
