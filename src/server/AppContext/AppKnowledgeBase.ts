...
• CHATS MENU (3-line ☰ in the v3.0 header): tap the menu icon at the top-left of the v3.0 header to open your CHAT LIST — every saved v3.0 project for your account, newest first — and tap any one to reopen it and continue exactly where you left off (same project, files, plan and memory). The same menu has a "+ New chat" to start a fresh project. Because chats are saved PER ACCOUNT (not per device), the list and the ability to continue the SAME project/memory work from ANY device you sign in on — open it on your phone, continue on your laptop, like Claude. ("New" in the header still starts a fresh project too.)
