...
export function architectSystemPrompt(framework?: string, opts?: { parallelBuild?: boolean }): string {
  ...
  return [
    ...
    '  Solid, Alpine, Vanilla and the plain static scaffold — there, the classes above exist and you should',
    '  reach for them directly. On the REMAINING scaffolds (Next, Nuxt, Astro, SvelteKit, Remix, Angular,',
    '  Lit) they do NOT exist yet, and writing them would give you class names with no CSS behind them —',
