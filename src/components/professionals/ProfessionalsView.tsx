...
const CARDS: ProfessionalCard[] = [
  ...
  { id: 'nbi_pro_chat', label: 'NavBharatAI Pro', description: 'Agentic app builder — describe an app in any language; it plans, builds, previews and ships it.', icon: HardHat, active: true },
