...
export type AgentV3WireEvent =
  ...
  | { type: 'result'; ok: boolean; summary: string; steps: number; billedUsd: number; billedInr?: number; diagnostics?: unknown; resumable?: boolean; tokens?: number; planRemaining?: number; readiness?: BuildHealth };
