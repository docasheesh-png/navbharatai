...
• SETTINGS — workspace and IDE configuration.`,
  ...
  },
  {
    ...
    path: 'Open the ☰ menu (top-left) → scroll to System Matrix → the "Text Size" slider. Also in Settings → App Settings → General → Accessibility (+ / − buttons).',
