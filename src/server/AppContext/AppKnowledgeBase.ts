...
• SETTINGS — workspace and IDE configuration.`,
  ...
  },
  {
    ...
    path: 'Settings → App Settings → Multi-Cloud Deploy',
    description: 'Deploy the app you built to the hosting platform of your choice — moved here from Home → Other AI (admin 2026-07-29). Platforms: NavBharat Hosting (instant live URL in seconds), Vercel, Netlify, Firebase Hosting, Google Cloud Run, Railway and Render. NavBharat Hosting and Vercel (when you paste your own VERCEL_TOKEN in the Config tab) deploy for REAL from inside the app and give you a live URL; the other platforms show the exact, honest CLI steps to run (build + deploy command) — nothing is faked. A Deploy history tab keeps your recent live URLs. Needs an app to be built first (it publishes your generated app bundle).',
    howToUse: 'Settings → App Settings → Multi-Cloud Deploy → pick a platform. For an instant live URL, choose NavBharat Hosting and press Deploy. For Vercel, add your VERCEL_TOKEN in the Config tab first, then Deploy. For other platforms, copy the CLI steps shown and run them in your terminal.',
    ...
    keywords: [
      ...
      'deploy kaise', 'app deploy', 'live kaise kare', 'website live', 'host karo',
    ],
  },
  {
    id: 'settings_auth',
