...
• HONEST billing: you are charged the Claude Opus-equivalent token cost × 2.5 (or × 5 in Only-Opus mode); a live cost estimate is shown.`,
  ...
  },
  {
    ...
    keywords: ['build report', 'diagnostics', 'diagnostic report', 'issues', 'errors report', 'download report', 'self diagnose', 'build issues', 'kya dikkat aayi', 'report download', 'json report', 'struggle', 'build log', 'issue list', 'technical report', 'sandbox logs', 'npm install error', 'stack trace', 'llm logs', 'raw logs', 'diagnosis bundle', 'why failed', 'kyu fail hua'],
    aiSurface: 'nbi_chat',
  },
  {
    id: 'agentv3_files',
