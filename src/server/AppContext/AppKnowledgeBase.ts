...
• SETTINGS — workspace and IDE configuration.`,
  ...
  },
  {
    ...
    howToUse: 'Home → Other AI → Bot Builder. Add and connect nodes to design the conversation, edit each node\'s text/options in the side panel, and try it with Simulate. When it feels right, tap "Build Bot App" — Pro v5.0 opens with the full build brief; press Send to build the real chatbot app.',
  ...
  // ─── SETTINGS ─────────────────────────────────────────────────────────────
  {
    ...
    path: 'Home → "Other AI" card → Open Tools',
    aiSurface: 'nbi_chat',
    ...
    howToUse: 'Open the Home page → tap the "Other AI" card → "Open Tools". The tool groups appear below; tap any tile to open that tool. (These were previously under Settings.)',
