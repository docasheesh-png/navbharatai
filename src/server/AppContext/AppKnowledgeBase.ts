...
• SETTINGS — workspace and IDE configuration.`,
  ...
  },
  {
    ...
    description: 'Sign in or create a NavBharatAI account. Authentication is required to save sessions, use Engineer AI, access Pro features, and store settings. Three ways to sign in: Email + Password, Phone number (OTP), or "Sign in with GitHub" (one click — best for users who already have a GitHub account; creates a normal NavBharatAI account). Google sign-in has been removed.',
    howToUse: 'Click the Login button in the top-right of the header. Choose Email or Phone, or tap "Sign in with GitHub" to log in with your GitHub account in one step. For phone, enter your number and verify the OTP.',
    relatedFeatures: ['history', 'settings_root'],
    keywords: ['login', 'sign in', 'sign up', 'register', 'account', 'auth', 'logout', 'email login', 'phone login', 'otp', 'mobile login', 'github login', 'github signin', 'sign in with github', 'login with github', 'github se login', 'login kaise', 'account kahan'],
  },
  {
    id: 'app_navigation',
