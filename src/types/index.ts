...
export type ViewType =
  ...
  | 'engineer_ai' | 'connect_domain' | 'teacher_ai' | 'mentor_ai' | 'thesis_ai' | 'accountant_ai' | 'lawyer_ai' | 'finance_ai' | 'astrologer_ai' | 'govt_schemes_ai' | 'kisan_ai' | 'nutritionist_ai' | 'wellness_ai' | 'fitness_ai' | 'vet_ai' | 'parenting_ai' | 'cybersafety_ai';
