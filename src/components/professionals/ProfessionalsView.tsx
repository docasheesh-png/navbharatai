...
const CARDS: ProfessionalCard[] = [
  ...
  { id: 'translate_ai', label: 'Language & Translation Helper', description: 'Translate & explain text across Indian & foreign languages, meaning & idioms, writing in another language, travel phrases — honest about limits (certified translator for official docs).', icon: Languages2, active: true },
