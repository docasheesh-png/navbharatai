...
• SEO/METADATA check (Section I #19): v3.0 checks the app's HTML entry for the discoverability essentials — a page title, viewport (mobile), meta charset (correct text encoding), meta description, html lang, and Open Graph tags (rich link previews on WhatsApp/social) — and flags any that are missing, so your app is search-friendly and shareable, not invisible.
