...
• SETTINGS — workspace and IDE configuration.`,
  ...
  {
    id: 'settings_swipe_gestures',
    name: 'Swipe Gestures (Left\u2192Right Action & On/Off)',
    path: 'Settings \u2192 General Settings \u2192 General \u2192 Accessibility \u2192 "Swipe gestures"',
    description: 'Controls what happens when you slide your finger across the screen. A master ON/OFF switch turns swipe gestures off entirely (useful if you keep opening things by accident), and a selector chooses what a LEFT\u2192RIGHT swipe does: OPEN MENU (opens the side menu \u2014 the default), GO BACK (goes back one screen, the way an iPhone does), or SWITCH TAB (moves to your previously open tab). Swiping RIGHT\u2192LEFT always closes the side menu when it is open, whichever action you picked. The choice is saved on your device (not your account) and applies to the very next swipe \u2014 no restart needed. Swipe gestures are a touchscreen feature, so they matter on phones and tablets.',
    howToUse: 'Open Settings \u2192 General Settings \u2192 General, scroll to Accessibility, and find "Swipe gestures". Use the top switch to turn swiping on or off. When it is on, pick what a left-to-right swipe should do: Open menu, Go back, or Switch tab. The change takes effect immediately.',
    relatedFeatures: ['settings_general', 'settings_root', 'settings_touch_feedback', 'settings_reduce_motion'],
    keywords: ['swipe', 'swipe gesture', 'gesture', 'slide', 'finger swipe', 'left to right', 'right to left', 'sidebar', 'side menu', 'menu opens by itself', 'menu khul jata hai', 'swipe band karo', 'swipe off', 'gesture off', 'turn off swipe', 'disable swipe', 'swipe se back', 'go back', 'back gesture', 'switch tab', 'tab badlo', 'accidental menu', 'galti se menu khul jata hai', 'accessibility'],
  },
  {
