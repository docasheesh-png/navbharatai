...
const BUILD_TOOLS: ToolName[] = ['read_file', 'write_file', 'edit_file', 'bash', 'grep', 'glob', 'recall', 'evaluate', 'generate_readme', 'generate_env_example', 'generate_gitignore', 'update_todo', 'update_preview'];
...
const REGISTRY: Record<AgentRole, RoleConfig> = {
  ...
  architect: {
    ...
    system:
      ...
      'completion.',
    tools: [...BUILD_TOOLS, 'task', 'second_opinion', 'consensus', 'web_search'],
