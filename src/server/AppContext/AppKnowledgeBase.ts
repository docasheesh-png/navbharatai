...
• IDE ↔ v3.0 FILE SYNC: a ZIP you upload in Code Studio is mirrored into the v3.0 workspace automatically, so v3.0 knows exactly which files exist and can build/edit on top of your uploaded code (the IDE and v3.0 share one workspace per session).
