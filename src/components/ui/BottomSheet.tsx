...
export function BottomSheet({ open, onClose, title, children, className }: BottomSheetProps) {
  ...
  useEffect(() => {
    ...
    // Trap focus inside the modal sheet (WCAG 2.4.3) so keyboard focus can't escape behind it.
  ...
  return (
    <>
      ...
      <div ref={panelRef} role="dialog" aria-modal="true" aria-label={typeof title === 'string' ? title : 'Sheet'} className={cn(bottomSheetClasses(), className)}>
