...
• SETTINGS — workspace and IDE configuration.`,
  ...
  },
  {
    ...
    description: 'Sign in or create a NavBharatAI account. Authentication is required to save sessions, use Engineer AI, access Pro features, and store settings. Sign in with Email + Password or with your Phone number (OTP). Google sign-in has been removed.',
    howToUse: 'Click the Login button in the top-right of the header. Choose Email or Phone, then create an account or sign in with an existing one. For phone, enter your number and verify the OTP.',
    relatedFeatures: ['history', 'settings_root'],
    keywords: ['login', 'sign in', 'sign up', 'register', 'account', 'auth', 'logout', 'email login', 'phone login', 'otp', 'mobile login', 'login kaise', 'account kahan'],
  },
  {
    id: 'app_navigation',
