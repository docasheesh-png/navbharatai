...
// Tool-set groups, by what a role is allowed to do.
const BUILD_TOOLS: ToolName[] = ['read_file', 'write_file', 'edit_file', 'bash', 'grep', 'glob', 'update_todo', 'update_preview'];
const EDIT_TOOLS: ToolName[] = ['read_file', 'write_file', 'edit_file', 'grep', 'glob'];
const RUN_TOOLS: ToolName[] = ['read_file', 'bash', 'grep', 'glob'];
