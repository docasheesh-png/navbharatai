...
- **Next un-done item (P1):** native tool-use loop — `ClaudeClient` (Anthropic SDK streaming + `tools`) + `AgentRunner` + `ToolCatalog`/`ToolDispatcher` on the hybrid E2B sandbox. Now UNBLOCKED (§11 answered).
