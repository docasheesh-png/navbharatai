...
const BUILD_TOOLS: ToolName[] = ['read_file', 'write_file', 'edit_file', 'bash', 'grep', 'glob', 'recall', 'evaluate', 'generate_readme', 'generate_env_example', 'generate_gitignore', 'generate_openapi', 'generate_api_docs', 'generate_tests', 'update_todo', 'update_preview'];
