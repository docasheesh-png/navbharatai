...
export function architectSystemPrompt(framework?: string, opts?: { parallelBuild?: boolean }): string {
  ...
  return [
    ...
    '  ⚠️ THE KIT CLASS NAMES ABOVE SHIP WITH THE VITE+REACT SCAFFOLD. On any other scaffold (Vue, Svelte,',
    '  Next, Astro, Nuxt, Angular, plain HTML, …) they do NOT exist — writing them would give you classes',
    '  with no CSS behind them, which is WORSE than plain markup. There, the five requirements are exactly',
    ...
    '  palette, and then reuse those on every page. The rule is the OUTCOME, never the specific class name.',
