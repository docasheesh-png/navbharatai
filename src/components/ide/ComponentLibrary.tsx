...
const WRAP = (body: string) =>
  `<!doctype html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><script src="https://cdn.tailwindcss.com"></script></head><body class="bg-surface p-4 font-sans">${body}</body></html>`;
...
const RAW_COMPONENTS: Omit<Component, 'id'>[] = [
  // ── Navigation ─────────────────────────────────────────────────────────────
  {
    ...
    html: `<nav class="bg-card border-b border-line px-6 py-3 flex items-center justify-between rounded-xl"><div class="flex items-center gap-2"><div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center"><span class="text-ink font-bold text-sm">N</span></div><span class="text-ink font-semibold text-lg">NavBharat</span></div><div class="hidden md:flex items-center gap-6"><a href="#" class="text-muted hover:text-ink text-sm transition">Home</a><a href="#" class="text-muted hover:text-ink text-sm transition">Features</a><a href="#" class="text-muted hover:text-ink text-sm transition">Pricing</a><a href="#" class="text-muted hover:text-ink text-sm transition">Docs</a></div><button class="bg-indigo-600 hover:bg-indigo-700 text-on-accent text-sm px-4 py-2 rounded-lg transition">Get Started</button></nav>`,
  },
  {
    ...
    html: `<div class="w-56 bg-card h-72 rounded-xl p-3 flex flex-col gap-1"><div class="flex items-center gap-2 px-3 py-2 mb-2"><div class="w-7 h-7 bg-indigo-600 rounded-lg"></div><span class="text-ink font-semibold text-sm">MyApp</span></div><a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-indigo-600/20 text-accent-text text-sm"><span>🏠</span>Dashboard</a><a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-muted hover:bg-raised hover:text-ink text-sm transition"><span>📁</span>Projects</a><a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-muted hover:bg-raised hover:text-ink text-sm transition"><span>👥</span>Team</a><a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-muted hover:bg-raised hover:text-ink text-sm transition"><span>📊</span>Analytics</a><a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-muted hover:bg-raised hover:text-ink text-sm transition"><span>⚙️</span>Settings</a></div>`,
  },
  {
    ...
    html: `<div class="bg-card rounded-xl p-4"><div class="flex border-b border-line"><button class="px-4 py-2 text-sm text-accent-text border-b-2 border-indigo-500 -mb-px font-medium">Overview</button><button class="px-4 py-2 text-sm text-muted hover:text-ink transition">Analytics</button><button class="px-4 py-2 text-sm text-muted hover:text-ink transition">Reports</button><button class="px-4 py-2 text-sm text-muted hover:text-ink transition">Settings</button></div><div class="pt-4 text-muted text-sm">Tab content goes here...</div></div>`,
  },
  {
    name: 'Breadcrumb', category: 'navigation', tags: ['breadcrumb','minimal'],
    description: 'Simple breadcrumb trail with chevron separators.',
    html: `<div class="bg-card rounded-xl p-4"><nav class="flex items-center gap-1 text-sm"><a href="#" class="text-muted hover:text-ink transition">Home</a><span class="text-faint">›</span><a href="#" class="text-muted hover:text-ink transition">Products</a><span class="text-faint">›</span><span class="text-ink font-medium">MacBook Pro</span></nav><h2 class="text-ink text-xl font-semibold mt-3">MacBook Pro</h2><p class="text-muted text-sm mt-1">Apple M3 Pro chip · 18GB RAM · 512GB SSD</p></div>`,
  },
  ...
  // ── Hero ───────────────────────────────────────────────────────────────────
  {
    ...
    html: `<section class="bg-gradient-to-br from-indigo-950 via-card to-purple-950 rounded-xl px-8 py-14 text-center"><div class="inline-flex items-center gap-2 bg-indigo-900/50 border border-indigo-700/50 rounded-full px-3 py-1 text-accent-text text-xs mb-6">✨ New: AI-powered builder</div><h1 class="text-ink text-4xl font-extrabold leading-tight mb-4">Build Faster with<br><span class="text-accent-text">NavBharat AI</span></h1><p class="text-muted text-base max-w-sm mx-auto mb-8">Ship beautiful web apps in minutes using our AI-driven no-code platform.</p><div class="flex items-center justify-center gap-3 flex-wrap"><button class="bg-indigo-600 hover:bg-indigo-700 text-on-accent px-6 py-3 rounded-xl font-medium transition">Start Free →</button><button class="border border-line hover:border-gray-400 text-muted hover:text-ink px-6 py-3 rounded-xl transition">See Demo</button></div></section>`,
  },
  {
    ...
    html: `<section class="bg-card rounded-xl p-8 flex gap-8 items-center"><div class="flex-1"><span class="text-accent-text text-xs font-semibold uppercase tracking-wider">Platform</span><h2 class="text-ink text-3xl font-bold mt-2 mb-4">Design. Build. Launch.</h2><p class="text-muted text-sm leading-relaxed mb-6">Everything you need to go from idea to production — AI co-pilot included.</p><div class="flex gap-3"><button class="bg-indigo-600 text-on-accent px-5 py-2.5 rounded-lg text-sm hover:bg-indigo-700 transition">Get Started</button><button class="text-accent-text text-sm hover:text-accent-text transition">Learn more →</button></div></div><div class="w-52 h-36 bg-gradient-to-br from-indigo-800/40 to-purple-800/40 rounded-xl border border-indigo-700/30 flex items-center justify-center text-faint text-xs flex-shrink-0">Image</div></section>`,
  },
  {
    name: 'Hero Minimal', category: 'hero', tags: ['minimal','centered','clean'],
    description: 'Centered minimal hero — text only, clean and elegant.',
    html: `<section class="bg-surface rounded-xl py-16 px-8 text-center"><p class="text-accent-text text-sm mb-3">Hello, World 👋</p><h1 class="text-ink text-4xl font-bold mb-4 tracking-tight">Less is More.</h1><p class="text-faint max-w-xs mx-auto text-sm leading-relaxed">Focus on what matters. Build with clarity and purpose.</p><button class="mt-8 text-sm text-accent-text border border-indigo-700 px-5 py-2 rounded-full hover:bg-indigo-900/30 transition">Explore →</button></section>`,
  },
  {
    ...
    html: `<section class="relative bg-surface rounded-xl overflow-hidden"><div class="absolute inset-0 bg-gradient-to-t from-surface via-surface to-transparent z-10"></div><div class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/30 via-transparent to-transparent"></div><div class="relative z-20 py-16 px-8 text-center"><span class="inline-block bg-red-600 text-on-accent text-xs px-3 py-0.5 rounded-full mb-4 font-medium">LIVE</span><h1 class="text-ink text-4xl font-extrabold mb-4">Streaming Now</h1><p class="text-muted text-sm mb-8">Watch the future being built, live.</p><button class="bg-white text-gray-900 font-semibold px-8 py-3 rounded-xl hover:bg-gray-100 transition">▶ Watch Now</button></div></section>`,
  },
  ...
  // ── Cards ──────────────────────────────────────────────────────────────────
  {
    ...
    html: `<div class="bg-raised rounded-2xl overflow-hidden w-48 shadow-lg"><div class="h-28 bg-gradient-to-br from-indigo-900 to-purple-900 flex items-center justify-center text-3xl">📦</div><div class="p-4"><h3 class="text-ink font-semibold text-sm">Premium Widget</h3><p class="text-muted text-xs mt-1">Quality craftsmanship</p><div class="flex items-center justify-between mt-3"><span class="text-accent-text font-bold text-base">₹999</span><button class="bg-indigo-600 text-on-accent text-xs px-3 py-1.5 rounded-lg hover:bg-indigo-700 transition">Buy Now</button></div></div></div>`,
  },
  {
    ...
    html: `<div class="bg-raised rounded-2xl p-6 w-52 text-center shadow-lg"><div class="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-on-accent text-2xl font-bold mx-auto mb-3">A</div><h3 class="text-ink font-semibold">Aarav Shah</h3><p class="text-accent-text text-xs mt-1">Full-Stack Developer</p><p class="text-faint text-xs mt-2">Building cool things at NavBharat</p><div class="flex justify-center gap-3 mt-4"><a href="#" class="text-muted hover:text-ink text-xs transition">𝕏</a><a href="#" class="text-muted hover:text-ink text-xs transition">in</a><a href="#" class="text-muted hover:text-ink text-xs transition">gh</a></div></div>`,
  },
  {
    ...
    html: `<div class="bg-raised rounded-2xl p-5 w-44 shadow-lg"><div class="flex items-start justify-between mb-3"><div class="w-10 h-10 bg-indigo-600/20 rounded-xl flex items-center justify-center text-accent-text text-lg">📈</div><span class="text-success text-xs font-medium bg-green-400/10 px-2 py-0.5 rounded-full">+12%</span></div><div class="text-3xl font-bold text-ink">4,281</div><div class="text-muted text-xs mt-1">Active Users</div><div class="mt-3 h-1 bg-raised rounded-full"><div class="h-1 bg-indigo-500 rounded-full w-3/4"></div></div></div>`,
  },
  {
    ...
    html: `<div class="bg-raised rounded-2xl overflow-hidden w-56 shadow-lg"><div class="h-28 bg-gradient-to-br from-blue-900 to-indigo-900 flex items-center justify-center text-3xl">📝</div><div class="p-4"><span class="text-accent-text text-xs">June 10, 2026</span><h3 class="text-ink font-semibold text-sm mt-1 leading-snug">How AI is Changing Web Dev</h3><p class="text-muted text-xs mt-2 leading-relaxed line-clamp-2">Discover how modern AI tools can speed up your entire development workflow...</p><a href="#" class="text-accent-text text-xs mt-3 inline-block hover:text-accent-text transition">Read More →</a></div></div>`,
  },
  ...
  // ── Forms ──────────────────────────────────────────────────────────────────
  {
    ...
    html: `<div class="bg-raised rounded-2xl p-6 w-72 shadow-xl"><h2 class="text-ink font-bold text-lg mb-1">Welcome back</h2><p class="text-muted text-xs mb-5">Sign in to your account</p><div class="space-y-3"><div><label class="text-muted text-xs mb-1 block">Email</label><input type="email" placeholder="you@example.com" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/></div><div><label class="text-muted text-xs mb-1 block">Password</label><input type="password" placeholder="••••••••" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/></div></div><button class="w-full bg-indigo-600 hover:bg-indigo-700 text-on-accent py-2 rounded-lg text-sm font-medium mt-5 transition">Sign In</button><p class="text-center text-faint text-xs mt-3">Don't have an account? <a href="#" class="text-accent-text">Sign up</a></p></div>`,
  },
  {
    ...
    html: `<div class="bg-raised rounded-2xl p-6 w-72 shadow-xl"><h2 class="text-ink font-bold text-lg mb-1">Create account</h2><p class="text-muted text-xs mb-5">Start building for free</p><div class="space-y-3"><div><label class="text-muted text-xs mb-1 block">Full Name</label><input type="text" placeholder="Aarav Shah" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/></div><div><label class="text-muted text-xs mb-1 block">Email</label><input type="email" placeholder="you@example.com" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/></div><div><label class="text-muted text-xs mb-1 block">Password</label><input type="password" placeholder="••••••••" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/></div></div><button class="w-full bg-indigo-600 hover:bg-indigo-700 text-on-accent py-2 rounded-lg text-sm font-medium mt-5 transition">Create Account</button></div>`,
  },
  {
    ...
    html: `<div class="bg-raised rounded-2xl p-6 w-72 shadow-xl"><h2 class="text-ink font-bold text-lg mb-1">Get in Touch</h2><p class="text-muted text-xs mb-5">We'll reply within 24 hours</p><div class="space-y-3"><input type="text" placeholder="Your name" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/><input type="email" placeholder="your@email.com" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500"/><textarea placeholder="Your message..." rows="3" class="w-full bg-card border border-line rounded-lg px-3 py-2 text-ink text-sm placeholder-faint focus:outline-none focus:border-indigo-500 resize-none"></textarea></div><button class="w-full bg-indigo-600 hover:bg-indigo-700 text-on-accent py-2 rounded-lg text-sm font-medium mt-4 transition">Send Message</button></div>`,
  },
  {
    ...
    html: `<div class="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-2xl p-6 text-center w-72"><h3 class="text-ink font-bold text-base mb-1">Stay in the Loop</h3><p class="text-accent-text text-xs mb-4">Get the latest updates delivered to your inbox.</p><div class="flex gap-2"><input type="email" placeholder="Enter your email" class="flex-1 bg-raised border border-indigo-600/50 rounded-lg px-3 py-2 text-ink text-sm placeholder-indigo-300/60 focus:outline-none focus:border-indigo-400"/><button class="bg-white text-indigo-700 font-semibold text-xs px-4 py-2 rounded-lg hover:bg-indigo-50 transition whitespace-nowrap">Subscribe</button></div><p class="text-accent-text text-xs mt-2">No spam. Unsubscribe anytime.</p></div>`,
  },
  ...
  // ── Footer ─────────────────────────────────────────────────────────────────
  {
    ...
    html: `<footer class="bg-card rounded-xl px-6 py-5"><div class="flex flex-col md:flex-row items-center justify-between gap-4"><div class="flex items-center gap-2"><div class="w-6 h-6 bg-indigo-600 rounded-md"></div><span class="text-ink font-semibold text-sm">NavBharat</span></div><div class="flex gap-5"><a href="#" class="text-muted hover:text-ink text-xs transition">Privacy</a><a href="#" class="text-muted hover:text-ink text-xs transition">Terms</a><a href="#" class="text-muted hover:text-ink text-xs transition">Contact</a><a href="#" class="text-muted hover:text-ink text-xs transition">Blog</a></div><p class="text-faint text-xs">© 2026 NavBharat. All rights reserved.</p></div></footer>`,
  },
  {
    ...
    html: `<footer class="bg-card rounded-xl px-6 py-8"><div class="grid grid-cols-3 gap-6 mb-6"><div><h4 class="text-ink font-semibold text-sm mb-3">Product</h4><div class="space-y-2"><a href="#" class="block text-muted hover:text-ink text-xs transition">Features</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Pricing</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Changelog</a></div></div><div><h4 class="text-ink font-semibold text-sm mb-3">Company</h4><div class="space-y-2"><a href="#" class="block text-muted hover:text-ink text-xs transition">About</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Blog</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Careers</a></div></div><div><h4 class="text-ink font-semibold text-sm mb-3">Support</h4><div class="space-y-2"><a href="#" class="block text-muted hover:text-ink text-xs transition">Docs</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Community</a><a href="#" class="block text-muted hover:text-ink text-xs transition">Status</a></div></div></div><div class="border-t border-line pt-4 flex justify-between items-center"><span class="text-ink font-semibold text-sm">NavBharat</span><p class="text-faint text-xs">© 2026 All rights reserved.</p></div></footer>`,
  },
  {
    name: 'Footer Dark', category: 'footer', tags: ['footer','dark','brand'],
    description: 'Bold dark footer with tagline and social icons.',
    html: `<footer class="bg-surface border-t border-line rounded-xl px-6 py-8 text-center"><div class="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center text-on-accent font-bold text-lg mx-auto mb-3">N</div><p class="text-ink font-semibold text-sm mb-1">NavBharat AI</p><p class="text-faint text-xs mb-5">Build the web. Faster.</p><div class="flex justify-center gap-4 mb-5"><a href="#" class="w-8 h-8 bg-raised hover:bg-raised rounded-lg flex items-center justify-center text-muted hover:text-ink text-xs transition">𝕏</a><a href="#" class="w-8 h-8 bg-raised hover:bg-raised rounded-lg flex items-center justify-center text-muted hover:text-ink text-xs transition">in</a><a href="#" class="w-8 h-8 bg-raised hover:bg-raised rounded-lg flex items-center justify-center text-muted hover:text-ink text-xs transition">gh</a></div><p class="text-faint text-xs">© 2026 NavBharat Technologies.</p></footer>`,
  },
  {
    name: 'Footer Minimal', category: 'footer', tags: ['footer','one-line','clean'],
    description: 'One-line minimal footer — just the essentials.',
    html: `<footer class="bg-card rounded-xl px-6 py-4 flex items-center justify-between"><span class="text-faint text-xs">© 2026 NavBharat</span><div class="flex gap-4"><a href="#" class="text-faint hover:text-ink text-xs transition">Privacy</a><a href="#" class="text-faint hover:text-ink text-xs transition">Terms</a></div></footer>`,
  },
  ...
  // ── Buttons ────────────────────────────────────────────────────────────────
  {
    ...
    html: `<div class="bg-card rounded-xl p-6 flex flex-wrap gap-3 items-center"><button class="bg-indigo-600 hover:bg-indigo-700 text-on-accent px-5 py-2.5 rounded-lg text-sm font-medium transition">Primary</button><button class="bg-purple-600 hover:bg-purple-700 text-on-accent px-5 py-2.5 rounded-lg text-sm font-medium transition">Purple</button><button class="bg-green-600 hover:bg-green-700 text-on-accent px-5 py-2.5 rounded-lg text-sm font-medium transition">Success</button><button class="bg-red-600 hover:bg-red-700 text-on-accent px-5 py-2.5 rounded-lg text-sm font-medium transition">Danger</button><button class="bg-raised hover:bg-raised text-ink px-5 py-2.5 rounded-lg text-sm font-medium transition">Secondary</button></div>`,
  },
  {
    ...
    html: `<div class="bg-card rounded-xl p-6 flex flex-wrap gap-3 items-center"><button class="border border-indigo-600 text-accent-text hover:bg-indigo-600 hover:text-on-accent px-5 py-2.5 rounded-lg text-sm font-medium transition">Outline</button><button class="border border-line text-muted hover:border-gray-400 hover:text-ink px-5 py-2.5 rounded-lg text-sm font-medium transition">Ghost</button><button class="text-accent-text hover:text-accent-text px-5 py-2.5 text-sm font-medium transition">Link →</button><button class="border border-dashed border-line text-muted hover:border-indigo-500 hover:text-accent-text px-5 py-2.5 rounded-lg text-sm font-medium transition">Dashed</button></div>`,
  },
  {
    ...
    html: `<div class="bg-card rounded-xl p-6 flex flex-wrap gap-4 items-center"><button class="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-on-accent px-6 py-2.5 rounded-xl text-sm font-medium transition shadow-lg shadow-indigo-900/50">Gradient CTA</button><button class="bg-gradient-to-r from-cyan-500 to-blue-500 text-on-accent px-6 py-2.5 rounded-xl text-sm font-medium transition shadow-lg shadow-blue-900/50">Ocean</button><button class="bg-gradient-to-r from-orange-500 to-pink-500 text-on-accent px-6 py-2.5 rounded-xl text-sm font-medium transition shadow-lg shadow-pink-900/50">Sunset</button></div>`,
  },
  {
    name: 'Button Icon', category: 'buttons', tags: ['button','icon','action'],
    description: 'Icon buttons and icon+label button combinations.',
    html: `<div class="bg-card rounded-xl p-6 flex flex-wrap gap-3 items-center"><button class="bg-indigo-600 hover:bg-indigo-700 text-on-accent px-4 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2">⬇ Download</button><button class="bg-raised hover:bg-raised text-ink px-4 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2">⚙ Settings</button><button class="w-10 h-10 bg-indigo-600/20 hover:bg-indigo-600 border border-indigo-600/40 text-accent-text hover:text-on-accent rounded-lg transition flex items-center justify-center text-base">+</button><button class="w-10 h-10 bg-raised hover:bg-raised text-muted hover:text-ink rounded-lg transition flex items-center justify-center text-base">🔔</button></div>`,
  },
  ...
  // ── Tables ─────────────────────────────────────────────────────────────────
  {
    ...
    html: `<div class="bg-card rounded-xl overflow-hidden"><table class="w-full text-sm"><thead><tr class="border-b border-line"><th class="text-left text-muted font-medium px-4 py-3">Name</th><th class="text-left text-muted font-medium px-4 py-3">Role</th><th class="text-left text-muted font-medium px-4 py-3">Status</th></tr></thead><tbody><tr class="border-b border-line"><td class="px-4 py-3 text-ink">Aarav Shah</td><td class="px-4 py-3 text-muted">Developer</td><td class="px-4 py-3"><span class="text-success bg-green-400/10 px-2 py-0.5 rounded-full text-xs">Active</span></td></tr><tr class="border-b border-line"><td class="px-4 py-3 text-ink">Priya Nair</td><td class="px-4 py-3 text-muted">Designer</td><td class="px-4 py-3"><span class="text-warn bg-yellow-400/10 px-2 py-0.5 rounded-full text-xs">Pending</span></td></tr><tr><td class="px-4 py-3 text-ink">Rohan Mehta</td><td class="px-4 py-3 text-muted">Manager</td><td class="px-4 py-3"><span class="text-info bg-blue-400/10 px-2 py-0.5 rounded-full text-xs">Online</span></td></tr></tbody></table></div>`,
  },
  {
    name: 'Table Striped', category: 'tables', tags: ['table','striped','zebra'],
    description: 'Striped zebra table for improved row readability.',
    html: `<div class="bg-card rounded-xl overflow-hidden"><table class="w-full text-sm"><thead><tr class="bg-indigo-900/30"><th class="text-left text-accent-text font-medium px-4 py-3">Product</th><th class="text-left text-accent-text font-medium px-4 py-3">Sales</th><th class="text-left text-accent-text font-medium px-4 py-3">Revenue</th></tr></thead><tbody><tr class="bg-raised"><td class="px-4 py-3 text-ink">Widget Pro</td><td class="px-4 py-3 text-muted">1,230</td><td class="px-4 py-3 text-success">₹1.2L</td></tr><tr><td class="px-4 py-3 text-ink">App Starter</td><td class="px-4 py-3 text-muted">845</td><td class="px-4 py-3 text-success">₹84.5K</td></tr><tr class="bg-raised"><td class="px-4 py-3 text-ink">AI Bundle</td><td class="px-4 py-3 text-muted">2,100</td><td class="px-4 py-3 text-success">₹4.2L</td></tr></tbody></table></div>`,
  },
  {
    ...
    html: `<div class="bg-card rounded-xl overflow-hidden"><table class="w-full text-sm"><thead><tr class="border-b border-line"><th class="text-left px-4 py-3 cursor-pointer hover:bg-raised transition group"><span class="text-muted font-medium flex items-center gap-1">Name <span class="text-faint group-hover:text-muted">↕</span></span></th><th class="text-left px-4 py-3 cursor-pointer hover:bg-raised transition group"><span class="text-muted font-medium flex items-center gap-1">Score <span class="text-accent-text">↑</span></span></th><th class="text-left px-4 py-3 cursor-pointer hover:bg-raised transition group"><span class="text-muted font-medium flex items-center gap-1">Date <span class="text-faint group-hover:text-muted">↕</span></span></th></tr></thead><tbody><tr class="border-b border-line hover:bg-raised transition"><td class="px-4 py-3 text-ink">Alpha</td><td class="px-4 py-3 text-accent-text">98</td><td class="px-4 py-3 text-muted">Jun 10</td></tr><tr class="border-b border-line hover:bg-raised transition"><td class="px-4 py-3 text-ink">Beta</td><td class="px-4 py-3 text-accent-text">74</td><td class="px-4 py-3 text-muted">Jun 8</td></tr><tr class="hover:bg-raised transition"><td class="px-4 py-3 text-ink">Gamma</td><td class="px-4 py-3 text-accent-text">61</td><td class="px-4 py-3 text-muted">Jun 5</td></tr></tbody></table></div>`,
  },
  {
    name: 'Table Dark', category: 'tables', tags: ['table','dark','compact'],
    description: 'Compact dark table with action buttons per row.',
    html: `<div class="bg-surface rounded-xl overflow-hidden border border-line"><table class="w-full text-sm"><thead><tr class="bg-card"><th class="text-left text-faint font-medium px-4 py-2.5 uppercase text-xs tracking-wider">User</th><th class="text-left text-faint font-medium px-4 py-2.5 uppercase text-xs tracking-wider">Plan</th><th class="text-right text-faint font-medium px-4 py-2.5 uppercase text-xs tracking-wider">Action</th></tr></thead><tbody><tr class="border-t border-line hover:bg-raised transition"><td class="px-4 py-3 text-ink text-xs">user@example.com</td><td class="px-4 py-3"><span class="bg-indigo-600 text-on-accent text-xs px-2 py-0.5 rounded">Pro</span></td><td class="px-4 py-3 text-right"><button class="text-muted hover:text-ink text-xs transition">Edit</button></td></tr><tr class="border-t border-line hover:bg-raised transition"><td class="px-4 py-3 text-ink text-xs">admin@company.in</td><td class="px-4 py-3"><span class="bg-yellow-600 text-ink text-xs px-2 py-0.5 rounded">Free</span></td><td class="px-4 py-3 text-right"><button class="text-muted hover:text-ink text-xs transition">Edit</button></td></tr></tbody></table></div>`,
  },
  ...
  // ── Alerts ─────────────────────────────────────────────────────────────────
  {
    ...
    html: `<div class="space-y-3 p-2"><div class="flex items-start gap-3 bg-green-900/30 border border-green-700/50 rounded-xl px-4 py-3"><span class="text-success mt-0.5">✓</span><div><p class="text-success font-medium text-sm">Operation Successful</p><p class="text-success text-xs mt-0.5">Your changes have been saved successfully.</p></div></div><div class="flex items-center gap-3 bg-green-900/20 border border-green-800/40 rounded-lg px-4 py-2.5"><div class="w-2 h-2 bg-green-500 rounded-full flex-shrink-0"></div><p class="text-success text-sm flex-1">Profile updated successfully!</p><button class="text-success hover:text-success text-lg leading-none">×</button></div></div>`,
  },
  {
    name: 'Alert Error', category: 'alerts', tags: ['alert','error','red'],
    description: 'Error/danger alert with descriptive message.',
    html: `<div class="space-y-3 p-2"><div class="flex items-start gap-3 bg-red-900/30 border border-red-700/50 rounded-xl px-4 py-3"><span class="text-danger mt-0.5">✕</span><div><p class="text-danger font-medium text-sm">Error Occurred</p><p class="text-danger text-xs mt-0.5">Failed to save changes. Please try again.</p></div></div><div class="flex items-center gap-3 bg-red-900/20 border border-red-800/40 rounded-lg px-4 py-2.5"><div class="w-2 h-2 bg-red-500 rounded-full flex-shrink-0"></div><p class="text-danger text-sm flex-1">Something went wrong. Please try again.</p><button class="text-danger hover:text-danger text-lg leading-none">×</button></div></div>`,
  },
  {
    name: 'Alert Warning', category: 'alerts', tags: ['alert','warning','yellow'],
    description: 'Warning alert for cautionary messages.',
    html: `<div class="space-y-3 p-2"><div class="flex items-start gap-3 bg-yellow-900/20 border border-yellow-700/40 rounded-xl px-4 py-3"><span class="text-warn mt-0.5">⚠</span><div><p class="text-warn font-medium text-sm">Heads Up!</p><p class="text-warn text-xs mt-0.5">Your account is nearing its usage limit.</p></div><button class="ml-auto text-yellow-600 hover:text-warn text-xs transition">Upgrade</button></div><div class="bg-yellow-900/10 border border-yellow-800/30 rounded-lg px-4 py-3"><p class="text-warn text-xs">⚡ Free plan: 7 days remaining. Upgrade to continue.</p></div></div>`,
  },
  {
    ...
    html: `<div class="space-y-3 p-2"><div class="flex items-start gap-3 bg-blue-900/20 border border-blue-700/40 rounded-xl px-4 py-3"><span class="text-info mt-0.5">ℹ</span><div><p class="text-info font-medium text-sm">New Update Available</p><p class="text-info text-xs mt-0.5">Version 2.1.0 is ready to install.</p></div><button class="ml-auto bg-blue-600 text-on-accent text-xs px-3 py-1 rounded-lg hover:bg-blue-700 transition flex-shrink-0">Update</button></div><div class="flex items-center gap-3 bg-raised border border-line rounded-lg px-4 py-2.5 shadow-xl"><div class="w-8 h-8 bg-indigo-600/20 rounded-lg flex items-center justify-center text-accent-text flex-shrink-0">🔔</div><p class="text-ink text-xs flex-1">Aarav commented on your project</p><span class="text-faint text-xs">2m ago</span></div></div>`,
  },
];
...
const buildSrcdoc = (html: string, customizer?: CustomizerState): string => {
  ...
  if (customizer) {
    ...
    styleInject = `<style>
      ...
      .text-accent-text, .text-accent-text { color: ${customizer.primaryColor} !important; }
